<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO usuarios(nome,email,senha,telefone,genero,data_nascimento,cidade,estado,endereco) 
    ...
    <div class="box">
        <form action="formulario.php" method="POST">
            <fieldset>
                ...
                <label for="data_nascimento"><b>Ano Nascimento</b></label> 
